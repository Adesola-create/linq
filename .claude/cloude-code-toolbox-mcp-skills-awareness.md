...
_Generated: 2026-05-20T13:15:34.171Z_
...
Workspace `mcp.json` _(folder: linq)_

- **c:\flutterapp\linq\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\livepetal\.claude.json** — _File exists — no servers defined_
