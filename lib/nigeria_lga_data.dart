/// Local Government Areas (LGAs) for each Nigerian state.
/// Keys match the state names used in [countriesAndStates]['Nigeria'].
const Map<String, List<String>> nigeriaLgasByState = {
  'Abia': [
  ...
  'Jigawa': [
    ...
    'Jahun', 'Kafin Hausa', 'Kazaure', 'Kiri Kasama', 'Kiyawa', 'Maigatari',
